...
nameof_pickel_calibrated_result = "result/calib_result_francois_171021_1620_delete_image"
...
class calibration:
    ...
    def undistort_imShow(self, frame):
        ...
        if flag_fisheye_calibrate == 0:
            ...
            #frame_undistorted_fisheye_new_camera_matrix = cv2.fisheye.undistortImage(frame, self.new_camera_matrix, self.distCoeffs, Knew=self.new_camera_matrix, new_size=(self.width, self.height))
